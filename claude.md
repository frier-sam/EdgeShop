...
2: check POD.md to see what is built or what needs to be built (the historical plan.md was the v1/v2 record and has been archived to docs/plans/2026-08-25-edgeshop-v1-v2-archive.md — POD.md is the live plan on this branch)
