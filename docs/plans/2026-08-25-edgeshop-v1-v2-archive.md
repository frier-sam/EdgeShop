# EdgeShop Implementation Plan (v1/v2 — ARCHIVED)

> **Archived 2026-08-25.** This is the historical record of the original multi-theme e-commerce build (v1 and v2). It was superseded by the print-on-demand conversion — see [`POD.md`](../../POD.md) for the live plan and current architecture. Kept for reference only; nothing here should be treated as describing the current app.
